...
const renderPostPage = (post) => {
    ...
    postContainer.innerHTML = `
        ...
        <article class="card">
            <div class="card-body">
                ...
                <small>Publié le ${dateFormatter.format(new Date(post.createdAt))}</small>
    ...
    document.querySelector('#back-button').addEventListener('click', renderPostsPage);
};
...
window.onload = async () => {
    ...
    document.querySelector('#create-post-button').addEventListener('click', renderCreatePostPage);
};
